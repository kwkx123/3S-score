...
cliFile="withoutBMT.txt"       #clinical data
setwd("E:\\10分文章新训练集\\131ssGSEA免疫分型\\40.Nomonew\\nomogram_code")     #Please set file path to "nomgram_code" file
...
riskFile="testRisk.txt"     #input risk file (test set)
cliFile="withoutBMT.txt"       #input clinical data (test set)
